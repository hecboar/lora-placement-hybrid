...
Machine-readable aggregate tables. All numbers are **single-seed (3407)** point estimates from the two tested models. Files are CSV; LaTeX renderings used in the manuscript are generated by the notebook but are not tracked here.
